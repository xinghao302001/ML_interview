...
from utils.load_data import loadDataForMniST
...
class KNN:
    ...
    def _getClosest(self, trainDataMat, trainLabelMat, x):
    ...
    def test(
        ...
        trainDataMat = np.mat(self.trainDataList)
        trainLabelMat = np.mat(self.trainLabelList).T
